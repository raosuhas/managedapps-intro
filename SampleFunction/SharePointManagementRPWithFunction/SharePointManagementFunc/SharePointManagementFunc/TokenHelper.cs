...
namespace SharePointManager
{
    public static class TokenHelper
    {
        ...
        //
        private static readonly string ClientId = Environment.GetEnvironmentVariable("spId");
        private static readonly string ClientSecret = Environment.GetEnvironmentVariable("spSecret");
